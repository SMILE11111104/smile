...
void menu_chon(){
    ...
    cout << '|' << setw(48) << "\t16. Sua thong tin bac sy" << '|' << endl;
    cout << '|' << setw(48) << "\t17. Sua thong tin don thuoc" << '|' << endl;
    cout << '|' << setw(48) << "\t18. Sua thong tin dich vu" << '|' << endl;
    cout << '|' << setw(48) << "\t19. Tim kiem bac sy hoac benh nhan" << '|' << endl;
...
void lay_du_lieu(){
    ...
    cout << '|' << setw(46) << "\t0.Nhap tu ban phim" << '|' << right << endl;
    cout << '|' << setfill('=') << setw(53) << '|' << setfill(' ') << endl;
    cout << "\n\t\tLUA CHON: ";
}
...
void hoi_xoa(){
    cout << endl;
    cout << '|' << setfill('=') << setw(32) << '|' << setfill(' ') << endl;
    cout << '|' << left << setw(25) << "\t1. Xoa benh nhan" << '|' << endl;
    cout << '|' << setw(25) << "\t2. Xoa bac sy" << '|' << endl;
    cout << '|' << setw(25) << "\t0.Thoat nhap" << '|' << right << endl;
    cout << '|' << setfill('=') << setw(32) << '|' << setfill(' ') << endl;
    cout << "\n\t\tLUA CHON: ";
}
...
void hoi_xoa_dtdv(){
    cout << endl;
    cout << '|' << setfill('=') << setw(32) << '|' << setfill(' ') << endl;
    cout << '|' << left << setw(25) << "\t1. Xoa thuoc" << '|' << endl;
    cout << '|' << setw(25) << "\t2. Xoa dich vu" << '|' << endl;
    cout << '|' << setw(25) << "\t0.Thoat nhap" << '|' << right << endl;
    cout << '|' << setfill('=') << setw(32) << '|' << setfill(' ') << endl;
    cout << "\n\t\tLUA CHON: ";
}
