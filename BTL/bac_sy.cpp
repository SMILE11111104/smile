...
class BS : protected PS{
    ...
    public:
        BS(){}
        BS(string ht, string cmt, string gt, string dc, NS ns, string ck, int sp, float bl);
        ~BS(){}
...
BS :: BS(string ht, string cmt, string gt, string dc, NS ns, string ck, int sp, float bl) : PS(ht, cmt, gt, dc, ns){
    this -> ck = ck;
    this -> sp = sp;
    this -> bl = bl;
}
